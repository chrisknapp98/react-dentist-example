...
export const services: readonly Service[] = [
  {
    ...
    paragraphs: [
      ...
      "Wir bieten Ihnen auch einen Recall-Service zur regelmäßigen Erinnerung an Ihren nächsten Termin an.",
    ],
  },
  {
    category: ServiceCategory.VorsorgeUndZahnerhalt,
    ...
    paragraphs: [
      ...
      "Auch die Aufklärung zur Vermeidung von Kariesentstehung, einer gesunden Ernährung sowie korrekter Mundhygiene sind uns wichtig.",
    ],
  },
  {
