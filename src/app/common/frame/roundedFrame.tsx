...
export function RoundedFrame({ title, children, className }: RoundedFrameProps) {
    return (
        <div className={`max-w-[45ch] rounded-2xl bg-practiceRed overflow-hidden shadow-lg items-center flex flex-col ${className ?? ""}`}>
