      ...
      <div className="px-6 mb-6 sm:px-20">
        ...
        <div className="text-sm text-gray-800 space-y-6 leading-relaxed">
          ...
          <div>
            ...
            <p>
              Telefon:{" "}
              <a href={ContactInformation.telephoneLink} className="underline">
                {ContactInformation.telephoneDisplay}
              </a>
              <br />
              E-Mail:{" "}
              <a href={ContactInformation.emailLink} className="underline">
          ...
          <div>
            ...
            <ul className="list-disc list-inside">
              <li>
                Zahnärzte (Dr. med. dent. Johannes Dumbach & Dr. med. dent.
                Stephanie Knapp Dumbach)
              </li>
              <li>
                Fachzahnarzt für Kieferorthopädie (Dr. med. dent. Georg Dumbach)
              </li>
            </ul>
            <p>
              <br />
            ...
            <p>
              Berufsbezeichnungen und Approbationen verliehen durch Bundesland
              Bayern / Bundesrepublik Deutschland
            </p>
            <p>
              Es gelten folgende berufsrechtliche Regelungen:
              <br />
              Berufsordnung für die bayerischen Zahnärzte, Gebührenordnung für
              Zahnärzte, Heilberufe-Kammergesetz, Zahnheilkundegesetz
              <br />
              einsehbar unter:{" "}
              <a
          ...
          <div>
            ...
            <p>
              Es besteht keine Bereitschaft oder Verpflichtung, an
